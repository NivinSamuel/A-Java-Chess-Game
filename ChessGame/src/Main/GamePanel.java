...
import Piece.Piece;
import Piece.Pawn; // Import the Pawn class
import Piece.Rook;
import Piece.Knight;
import Piece.Bishop;
import Piece.King;
...
public class GamePanel extends JPanel implements Runnable {
        ...
        if(promotion){
            ...
            if (mouse.pressed){
                if(activeP == null){
                    ...
                    //If a player is holding a piece
                    simulate();
                }
            }
    ...
    private void simulate(){
        ...
        //Check if the piece is hovering over a rechable square
    ...
    private boolean isCheckmate(){
        ...
        if(kingCanMove(king)){
            ...
            //Check if you can block the attack with the piece
            ...
            if(colDiff == 0){
                ...
                if(checkingP.col < king.col){
                    //The checking pieces is to the left
    ...
    private boolean isValidMove(Piece king, int colPlus, int rowPlus){
        ...
        //Update the kings position for the second
        king.col += colPlus;
        king.row += rowPlus;
    ...
    public void paintComponent(Graphics g){
        ...
        if (activeP != null){
            ...
            //Draw the active piect in the end so it wont be hidden by the board or the colored square
            activeP.draw(g2);
